...
export default function About(): JSX.Element {
  return (<MaterialCard column noAnimate background={ colors.ivory }>
    ...
    <Body margins="2rem 6rem 0.5rem 6rem" mobMargins="0 1rem 0 1rem"
      ...
      covers the most realistic and relevant themes in international politics
      and ensures they are explored through challenging debate.
      <br/>
      <br/>
    </Body>
    ...
    <Body margins="2rem 6rem 0rem 6rem" mobMargins="0 1rem 0 1rem" line={ 1.4 }
      ...
      politics through realistic, fast-paced experiential education programs
      that promote critical thinking and leadership development.
      <br/>
      <br/>
    </Body>
    <SubTitle margins="0rem 6rem 0rem 6rem" mobMargins="0 1rem 0 1rem"
    ...
    <Body margins="0 6rem 0.5rem 6rem" mobMargins="0 1rem 0 1rem"
      ...
      simulating the work of actual diplomats in a variety of
      forums&mdash;awards are not given for passing empty resolutions or
      ...
      their feet and work across multiple committees. From the General Assembly
      to our Parliamentary Cabinets and Regional Bodies, all of our committees
      are vital participants in the crisis, constituting one of the largest
      ...
      part of the simulation, using both traditional media formats and social
      media.
      <br/>
      <br/>
    </Body>
