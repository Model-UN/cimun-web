  ...
  return (
    <MaterialCard column noAnimate background={colors.ivory}>
      ...
      <Body
        ...
        size="1.25rem"
      >
        CIMUN staff consists of a multitude of working professionals as well as college students. 
        Despite being in many different career fields, our staff shares a love for Model UN and the ability to create 
